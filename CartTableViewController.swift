...
class CartTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        var findItem = searchItem(idNumber: cartList[indexPath.row])
        
        cell.itemName.text = findItem.ItemName
        
        cell.ItemPrice.text = "Price: $" + String(findItem.ItemPrice)
    ...
    func searchItem(idNumber: Int) -> ShoppingItem{
        for item in myTable{
