...
class ShopListTable: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.itemName.text =  myTable[indexPath.row].ItemName
       
        cell.ItemPrice.text = "Price: $" +  String(myTable[indexPath.row].ItemPrice)
